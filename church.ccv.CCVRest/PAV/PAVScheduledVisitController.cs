...
namespace church.ccv.CCVRest.PAV
{
    public partial class PlanAVisitController : Rock.Rest.ApiControllerBase
    {
        ...
        {
            PAVScheduledVisitService.RecordAttendedResponse updateResponse = PAVScheduledVisitService.RecordAttended( visitId, attendedCampusId, attendedScheduleId, attendedDate, out string message );

...
namespace Rock.Web
{
    ...
    public sealed class RockRouteHandler : IRouteHandler
    {
        ...
        #region Can be removed when upgrading to v9
        /// <summary>
        ...
        public static void RegisterRoutes()
        {
            ...
            {
                var pageAndRouteIdList = new List<PageAndRouteId>();
                pageAndRouteIdList.Add( new PageAndRouteId { PageId = pageRoute.PageId, RouteId = pageRoute.Id } );
                routesToInsert.AddPageRoute( pageRoute.Route, pageAndRouteIdList );
            }

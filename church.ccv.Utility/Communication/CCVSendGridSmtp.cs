...
namespace church.ccv.Utility.Communication
{
    ...
    /// </summary>
    [Description( "Sends a communication through SendGrid's SMTP API. Customized to inherit from CCV's custom SMTPComponent" )]
    [Export( typeof( TransportComponent ) )]
    [ExportMetadata( "ComponentName", "CCV SendGrid SMTP" )]
    ...
    public class CCVSendGridSmtp : CCVSMTPComponent
    {
        /// <summary>

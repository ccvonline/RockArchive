<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCV_RegistrationInstanceDetail.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Event.CCV_RegistrationInstanceDetail" %>

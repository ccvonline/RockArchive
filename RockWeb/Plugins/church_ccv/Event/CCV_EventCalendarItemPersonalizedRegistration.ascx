<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCV_EventCalendarItemPersonalizedRegistration.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Event.CCV_EventCalendarItemPersonalizedRegistration" %>

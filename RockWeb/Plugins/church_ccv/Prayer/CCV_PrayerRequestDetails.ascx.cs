...
{
    [DisplayName( "CCV Prayer Request Detail" )]
    [Category( "Prayer" )]
    ...
    public partial class CCV_PrayerRequestDetail : RockBlock, IDetailBlock
    {
        #region Properties
...
";
        ...
        private void ShowEditDetails( PrayerRequest prayerRequest )
        {
            ...
            requesterEmail.Text = prayerRequest.Email;
        ...
        private void SaveRequest()
        {
            ...
            prayerRequest.Email = requesterEmail.Text;

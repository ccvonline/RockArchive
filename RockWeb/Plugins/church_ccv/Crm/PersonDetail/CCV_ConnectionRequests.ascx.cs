...
namespace RockWeb.Plugins.church_ccv.Crm.PersonDetail
{
    /// <summary>
    /// 
    /// </summary>
    [DisplayName( "CCV Connection Requests" )]
    [Category( "CRM > Person Detail" )]
    [Description( "Allows you to view connection requests of a particular person." )]

    [LinkedPage( "Connection Request Detail" )]
    public partial class CCV_ConnectionRequests : Rock.Web.UI.PersonBlock
    {
        /// <summary>
                    ...
                    using ( var rockContext = new RockContext() )
                    {
                        ...
                        foreach ( var connectionRequest in connectionRequestList )
                        {
                            ...
                            listHtml += string.Format(
                                ...
                                ( connectionRequest.ConnectionState == ConnectionState.Connected || connectionRequest.ConnectionState == ConnectionState.Inactive ) ? "class='is-active'" : string.Empty,
                                connectionNameHtml,

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCV_ConnectionRequests.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Crm.PersonDetail.CCV_ConnectionRequests" %>

...
{
    public class GroupDistanceObject : Rock.Lava.ILiquidizable
    {
        ...
        public List<string> AvailableKeys
        {
            get
            {
                var availableKeys = new List<string> { "GroupId", "Distance" };
        ...
        {
            var additionalKeys = new List<string> { "GroupId", "Distance" };
...
", "CustomSetting" )]
    ...
    public partial class CCVGroupFinder : RockBlockCustomSettings
    {
        ...
        private void ShowResults()
        {
            ...
            List<GroupDistanceObject> groupDistanceList = new List<GroupDistanceObject>();
...
", personLocation.FormattedHtmlAddress );
                ...
                foreach ( var group in groups )
                {
                        ...
                        .Where( gl => gl.Location.GeoPoint != null ) )
                    {
                        ...
                        if ( showProximity && personLocation != null && personLocation.GeoPoint != null )
                        {
                            ...
                            {
                                distances.Add( group.Id, Math.Round( miles, 2 ) );
                                GroupDistanceObject groupDistance = new GroupDistanceObject();
                                groupDistance.GroupId = group.Id;
                                groupDistance.Distance = Math.Round( miles, 2 );


                                groupDistanceList.Add( groupDistance );
                            }
                        }
                    }
                }
            ...
            if ( GetAttributeValue( "ShowLavaOutput" ).AsBoolean() )
            {
                ...
                mergeFields.Add( "LinkedPages", linkedPages );
                mergeFields.Add( "CampusContext", RockPage.GetCurrentContext( EntityTypeCache.Read( "Rock.Model.Campus" ) ) as Campus );
                mergeFields.Add( "GroupDistanceList", groupDistanceList );

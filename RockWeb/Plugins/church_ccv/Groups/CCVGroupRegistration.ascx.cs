...
namespace RockWeb.Plugins.church_ccv.Groups
{
    ...
    /// 
    /// </summary>
    [DisplayName("CCV Group Registration")]
    [Category("CCV > Groups")]
...
", "", 9)]
    ...
    public partial class CCVGroupRegistration : RockBlock
    {
        #region Fields
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid && _isValidSettings)
            {
                ...
                if (alertNoteCount > 0)
                {
                    ...
                    LaunchWorkflow(rockContext, alertRerouteWorkflowType, person);
                }
        ...
        public static void LaunchWorkflow(RockContext rockContext, WorkflowTypeCache workflowTypeCache, object contextEntity)
        {
            try
            {
        ...
        private void AddPersonToGroup(RockContext rockContext, Person person, WorkflowTypeCache workflowType, List<GroupMember> groupMembers)
        {
            if (person != null)
            {
                ...
                {
                    LaunchWorkflow(rockContext, workflowType, person);
                }
            }
        }

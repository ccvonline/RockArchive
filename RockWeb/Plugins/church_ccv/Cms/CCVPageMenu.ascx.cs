...
/// CCV Core Fork - Added Campuses to Lava merge fields - cfu 12-19-18

namespace RockWeb.Plugins.church_ccv.Cms
{
    [DisplayName( "CCV Page Menu" )]
    [Category( "CCV > Cms" )]
    ...
    public partial class CCVPageMenu : RockBlock, ISecondaryBlock
    {
        ...
        private void Render()
        {
            try
            {
                ...
                pageProperties.Add( "Campuses", campuses );

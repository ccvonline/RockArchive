...
namespace RockWeb.Plugins.church_ccv.CheckIn
{
    /// <summary>
    /// 
    /// </summary>
    [DisplayName( "CCV Schedule Builder" )]
    [Category( "CCV > Check-in" )]
    [Description( "Helps to build schedules to be used for checkin." )]
    public partial class CCVCheckinScheduleBuilder : RockBlock, ICustomGridOptions
    {
        ...
        protected void btnApplyGroupFilter_Click( object sender, EventArgs e )
        {
            SetBlockUserPreference( "Group", tbGroup.Text);
            BindGrid();
        }
        ...
        private void BindFilter()
        {
            ...
            //BindGroupList();
            tbGroup.Text = GetBlockUserPreference( "Group" );
        ...
        protected void BindGrid()
        {
            ...
            //ddlGroup.SetValue( GetBlockUserPreference( "Group" ) );
            string groupText = tbGroup.Text;
            if ( groupText.IsNotNullOrWhiteSpace() )
            {
                groupLocationQry = groupLocationQry.Where( gl => gl.Group.Name.Contains( groupText ) );
            }

(function(){
    ...
    function loadMap() {
      ...
      CCV.campusInfoWindowMap.prototype.buildInfoWindow = function(campus) {
        ...
        result += '  <div class="name">'+campus.name+' Campus - Childcare</div>'
        ...
        result += '  </div>'
        result += '  <br />'
        if ( campus.healthcareChildcareTimes != "" ) {
            result += '  <div>'+campus.healthcareChildcareAges+'</div>'
            result += '  <br />'
            result += '  <div>Hours: '+campus.healthcareChildcareTimes+'</div>'
            if ( campus.healthcareChildcareRegistrationInstanceId && campus.healthcareChildcareRegistrationInstanceId > 0 ) {
              result += '  <a class="select" href="/info/childcare-registration?RegistrationInstanceId=' + campus.healthcareChildcareRegistrationInstanceId + '"' + '>Register</a>'
            } else {
              result += '<div class="select" style="cursor:auto;">Registration currently closed</div>'
            }
        } else {
            result += ' <div class="select" style="cursor:auto;">Currently childcare is not available at this campus</div>'
        }
        result += '</div>'
        return result
      }
